                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    ...
                                                    <form action="{{ route('hasil-uji-troli.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')" style="display:inline-block; margin:0;">
                                                        @csrf @method('DELETE')
