                                ...
                                <tbody>
                                    @foreach ($tabelData as $item)
                                        <tr>
                                            ...
                                            <td class="text-right">{{ number_format($item->sd_bulan_lalu, 0, ',', '.') }}</td>
                                            
                                            {{-- Kolom Yg Lalu Highlight --}}
                                            <td class="text-right ">{{ number_format($item->bln_ini_lalu, 0, ',', '.') }}</td>
                                            
                                            <td class="text-right font-weight-bold ">{{ number_format($item->hari_ini, 0, ',', '.') }}</td>
                                            <td class="text-right font-weight-bold">{{ number_format($item->total_bln_ini, 0, ',', '.') }}</td>
                                            <td class="text-right font-weight-bold">{{ number_format($item->total_sd_hari_ini, 0, ',', '.') }}</td>
                                    ...
                                    <tr class="row-jumlah">
                                        ...
                                        <td class="text-right">{{ number_format($tabelData->sum('sd_bulan_lalu'), 0, ',', '.') }}</td>
                                        <td class="text-right">{{ number_format($tabelData->sum('bln_ini_lalu'), 0, ',', '.') }}</td>
                                        <td class="text-right">{{ number_format($tabelData->sum('hari_ini'), 0, ',', '.') }}</td>
                                        <td class="text-right">{{ number_format($tabelData->sum('total_bln_ini'), 0, ',', '.') }}</td>
                                        <td class="text-right bg-warning">{{ number_format($tabelData->sum('total_sd_hari_ini'), 0, ',', '.') }}</td>
                                        <td>-</td>
                                        <td></td>
                                    </tr>
                                </tbody>
