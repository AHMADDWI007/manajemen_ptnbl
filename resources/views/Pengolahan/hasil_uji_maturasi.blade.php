...
<head>
    ...
    <style>
        /* Aturan Global untuk sel tabel */
        .table-bordered th, 
        .table-bordered td {
            border: 1px solid #dee2e6; /* Perbaiki typo */
...
<div class="wrapper">
    ...
    {{-- ... (Modal Tambah, Detail, Edit tetap sama) ... --}}
    {{-- MODAL TAMBAH --}}
            ...
            <div class="modal-content">
                <form id="formEdit" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"> <label>No. Kamar</label> <input type="text" name="no_kamar" id="editNoKamar" class="form-control" required> </div>
